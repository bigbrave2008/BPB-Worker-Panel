        ...
        try {
            ...
            if (!upgradeHeader || upgradeHeader !== 'websocket') {
                ...
                switch (url.pathname) {
                    ...
                    case '/fe385f03-f5e1-49c3-b4dc-f69ff31a7e97':
                    ...
                    case '/login':
                        ...
                        if (loginAuth) return Response.redirect(`${url.origin}/fe385f03-f5e1-49c3-b4dc-f69ff31a7e97`, 302);
                    ...
                    case '/fe385f03-f5e1-49c3-b4dc-f69ff31a7e97/password':
	...
	<script>
        ...
        const applySettings = async (event, configForm) => {
            ...
            try {
                ...
                const response = await fetch('/fe385f03-f5e1-49c3-b4dc-f69ff31a7e97', {
                    method: 'POST',
                    body: formData,
                    credentials: 'include'
                });
        ...
        const resetPassword = async (event) => {
            ...
            try {
                const response = await fetch('/fe385f03-f5e1-49c3-b4dc-f69ff31a7e97/password', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'text/plain'
                    },
    ...
    <script>
        document.getElementById('loginForm').addEventListener('submit', async (event) => {
            ...
            try {
                ...
                if (response.ok) {
                    window.location.href = '/fe385f03-f5e1-49c3-b4dc-f69ff31a7e97';
                } else {
